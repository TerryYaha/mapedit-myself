...
function getCustomControls(fabric) {
  const {
...
function getCustomBackgroundControls(fabric) {
  const { ml, mr, mb, mt, tl, tr, bl, br } = getCustomControls(fabric);
  return { ml, mr, mb, mt, tl, tr, bl, br };
}

function getCustomTextControls(fabric) {
  const {
    scaleSkewCursorStyleHandler: scaleSkewStyleHandler,
    changeWidth,
    rotationWithSnapping,
