    ...
    <div class="material__content" v-show="source === MaterialSource.Official">
      <div class="material__search">
        <MaterialSearch
          :onSearch="onSearch"
          :materialSearchType="
            inputTextPlaceholder === '' ? '“地板”' : inputTextPlaceholder
          "
           :onClear="onClear"
        />
      </div>
      ...
      <div class="material__space" always/>
...
import MaterialListFloor from "./components/MaterialListFloor.vue";
